...
df2 = df[(df["Geology"] == "al+vr") & (df["longitude"] > 25.7) & (df["latitude"] < 46.2) & (df["latitude"] > 45.2)]
df2bis = df[(df["Geology"] == "ne") & (df["longitude"] > 25.7) & (df["latitude"] < 46.2)& (df["latitude"] > 45.2)]
df2ter = df[(df["Geology"] == "al+tu") & (df["longitude"] > 25.7) & (df["latitude"] < 46.2) & (df["latitude"] > 45.2)]
df2quat = df[(df["Geology"] == "vr+cm") & (df["longitude"] > 25.7) & (df["latitude"] < 46.2) & (df["latitude"] > 45.2)]
df2cinq = df[(df["Geology"] == "ne+ap") & (df["longitude"] > 25.7) & (df["latitude"] < 46.2) & (df["latitude"] > 45.2)]
...
# df2.to_csv('C:\Users\Maxime\Desktop\UniED\Scripts\csv_df2.txt', index = False)
...
# df3.to_csv('C:\Users\Maxime\Desktop\UniED\Scripts\csv_df3.txt', index = False)
...
# df4.to_csv('C:\Users\Maxime\Desktop\UniED\Scripts\csv_df4.txt', index = False)
# bleu clair

df5 = df[(df["Geology"] == "br-al") & (df["longitude"] < 26.10) & (df["latitude"] < 46.2) & (df["longitude"] > 25.30)]

df5bis = df[(df["Geology"] == "ne") & (df["longitude"] < 26.10) & (df["latitude"] < 46.2) & (df["longitude"] > 25.30)]
df5ter = df[(df["Geology"] == "al") & (df["longitude"] < 26.10) & (df["latitude"] < 46.2) & (df["longitude"] > 25.30)]


df5ter = df2bis.append(df5ter)
df5 = df5ter.append(df5)
# df5.to_csv('C:\Users\Maxime\Desktop\UniED\Scripts\csv_df5.txt', index = False)

df_list = [df2, df3, df4, df5]

df_final = pd.concat(df_list)

df_final.to_csv('C:\Users\Maxime\Desktop\UniED\Scripts\csv_south.txt', index = False)
